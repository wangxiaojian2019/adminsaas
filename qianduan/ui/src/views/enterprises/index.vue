  ...
  <div class="enterprises-container">
    <el-card shadow="never" class="main-card">
      ...
      <el-table :data="processedTableData" v-loading="loading" border stripe style="width: 100%">
        ...
        <el-table-column label="在缴物业(元)" width="110" align="right">
          <template #default="{ row }"><span v-if="row.property_fee !== null">¥ {{ row.property_fee }}</span><span v-else>-</span></template>
        </el-table-column>
